...
### AWS Lambda adapter [#17](https://github.com/m0nkey/technician/issues/17)
...
### Prometheus remote-write [#19](https://github.com/m0nkey/technician/issues/19)
...
See [deployment-sizing.md § Persistence](deployment-sizing.md#persistence-and-historical-data) for the full analysis and [#16](https://github.com/m0nkey/technician/issues/16) for implementation tracking.
...
### IaC templates [#21](https://github.com/m0nkey/technician/issues/21)
...
### Structured logging for Loki [#24](https://github.com/m0nkey/technician/issues/24)
...
### Status page redesign [#25](https://github.com/m0nkey/technician/issues/25)
...
- **Latency percentile Grafana panels** [#35](https://github.com/m0nkey/technician/issues/35) — The Grafana dashboards have latency trend graphs but no dedicated P50/P90/P99 panels. Add percentile stat panels and histogram panels to the HTTP Timing and Uptime Overview dashboards.
...
- **Module path** [#42](https://github.com/m0nkey/technician/issues/42) — `github.com/m0nkey/technician` uses a personal GitHub account. Consider a dedicated org or project namespace.
